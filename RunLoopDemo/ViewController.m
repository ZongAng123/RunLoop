...
- (void)viewDidLoad {
    ...
    _imageView = [[UIImageView alloc]initWithFrame:CGRectMake(70, 712, 100, 100)];
    [self.view addSubview:_imageView];
    
    _btn = [[UIButton alloc]initWithFrame:CGRectMake(81, 300, 93, 48)];
    [_btn setTitle:@"RunLoop" forState:UIControlStateNormal];
